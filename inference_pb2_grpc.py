...
class InferenceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Generate = channel.unary_stream(
                ...
                response_deserializer=inference__pb2.GenerateEvent.FromString,
...
def add_InferenceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Generate': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=inference__pb2.GenerateEvent.SerializeToString,
            ),
    }
...
class Inference(object):
    ...
    def Generate(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            inference__pb2.GenerateEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
